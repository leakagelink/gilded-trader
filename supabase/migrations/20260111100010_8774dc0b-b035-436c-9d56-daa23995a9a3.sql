-- Update approve_deposit function to use dynamic exchange rate from payment_settings
...
BEGIN
  ...
  VALUES (v_deposit.user_id, 'deposit', v_total_amount, 'USD', 'Completed', deposit_id::text);
END;
$$;